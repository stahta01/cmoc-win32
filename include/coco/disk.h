...
// Decimal 225 (0xE1/$E1) [Constant] - HIGHEST 1.1 DISK TOKEN
#ifndef _DHITOK
#define _DHITOK 225
#endif
...
// Decimal 0 (0x0/$0) [Constant] - ACTIVE FILE COUNTER : DISK TO RAM FAT IMAGE DISABLE
#ifndef _FAT0
#define _FAT0 0
#endif

// Decimal 1 (0x1/$1) [Constant] - VALID DATA FLAG: 0=DISK DATA VALID, <> 0 = NEW FAT
#ifndef _FAT1
#define _FAT1 1
#endif

// Decimal 6 (0x6/$6) [Constant] - OFFSET TO START OF FAT DATA (68 BYTES)
#ifndef _FATCON
#define _FATCON 6
#endif

// Decimal 0 (0x0/$0) [Constant] - FILE NAME
#ifndef _DIRNAM
#define _DIRNAM 0
#endif

// Decimal 8 (0x8/$8) [Constant] - FILE EXTENSION
#ifndef _DIREXT
#define _DIREXT 8
#endif

// Decimal 11 (0xB/$B) [Constant] - FILE TYPE
#ifndef _DIRTYP
#define _DIRTYP 11
#endif

// Decimal 12 (0xC/$C) [Constant] - ASCII FLAG
#ifndef _DIRASC
#define _DIRASC 12
#endif

// Decimal 13 (0xD/$D) [Constant] - FIRST GRANULE IN FILE
#ifndef _DIRGRN
#define _DIRGRN 13
#endif

// Decimal 14 (0xE/$E) [Constant] - NUMBER OF BYTES IN LAST SECTOR
#ifndef _DIRLST
#define _DIRLST 14
#endif

// Decimal 0 (0x0/$0) [Constant] - FILE TYPE: $40=RANDOM/DIRECT, 0=CLOSED
#ifndef _FCBTYP
#define _FCBTYP 0
#endif

// Decimal 1 (0x1/$1) [Constant] - DRIVE NUMBER
#ifndef _FCBDRV
#define _FCBDRV 1
#endif

// Decimal 2 (0x2/$2) [Constant] - FIRST GRANULE IN FILE
#ifndef _FCBFGR
#define _FCBFGR 2
#endif

// Decimal 3 (0x3/$3) [Constant] - CURRENT GRANULE BEING USED
#ifndef _FCBCGR
#define _FCBCGR 3
#endif

// Decimal 4 (0x4/$4) [Constant] - CURRENT SECTOR BEING USED (1-9)
#ifndef _FCBSEC
#define _FCBSEC 4
#endif

// Decimal 6 (0x6/$6) [Constant] - CURRENT PRINT POSITION - ALWAYS ZERO IN RANDOM FILES
#ifndef _FCBPOS
#define _FCBPOS 6
#endif

// Decimal 7 (0x7/$7) [Constant] - CURRENT RECORD NUMBER
#ifndef _FCBREC
#define _FCBREC 7
#endif

// Decimal 9 (0x9/$9) [Constant] - RANDOM FILE RECORD LENGTH
#ifndef _FCBRLN
#define _FCBRLN 9
#endif

// Decimal 11 (0xB/$B) [Constant] - POINTER TO START OF THIS FILE'S RANDOM ACCESS BUFFER
#ifndef _FCBBUF
#define _FCBBUF 11
#endif

// Decimal 13 (0xD/$D) [Constant] - SECTOR OFFSET TO CURRENT POSITION IN RECORD
#ifndef _FCBSOF
#define _FCBSOF 13
#endif

// Decimal 15 (0xF/$F) [Constant] - GET/PUT FLAG: 0=PUT, 1=PUT
#ifndef _FCBFLG
#define _FCBFLG 15
#endif

// Decimal 18 (0x12/$12) [Constant] - DIRECTORY ENTRY NUMBER (0-71)
#ifndef _FCBDIR
#define _FCBDIR 18
#endif

// Decimal 19 (0x13/$13) [Constant] - NUMBER OF BYTES IN LAST SECTOR OF FILE
#ifndef _FCBLST
#define _FCBLST 19
#endif

// Decimal 21 (0x15/$15) [Constant] - 'GET' RECORD COUNTER: HOW MANY CHARACTERS HAVE BEEN PULLED OUT OF THE CURRENT RECORD
#ifndef _FCBGET
#define _FCBGET 21
#endif

// Decimal 23 (0x17/$17) [Constant] - 'PUT' RECORD COUNTER: POINTER TO WHERE IN THE RECORD THE NEXT BYTE WILL BE 'PUT'
#ifndef _FCBPUT
#define _FCBPUT 23
#endif

// Decimal 5 (0x5/$5) [Constant] - INPUT FILE: CHARACTER POINTER - POINTS TO NEXT CHARACTER IN
#ifndef _FCBCPT
#define _FCBCPT 5
#endif

// Decimal 16 (0x10/$10) [Constant] - CACHE FLAG: 00=CACHE EMPTY, $FF=CACHE FULL
#ifndef _FCBCFL
#define _FCBCFL 16
#endif

// Decimal 17 (0x11/$11) [Constant] - CACHE DATA BYTE
#ifndef _FCBCDT
#define _FCBCDT 17
#endif

// Decimal 23 (0x17/$17) [Constant] - INPUT FILE ONLY: DATA LEFT FLAG: 0=DATA LEFT, $FF=NO DATA (EMPTY)
#ifndef _FCBDFL
#define _FCBDFL 23
#endif

// Decimal 24 (0x18/$18) [Constant] - NUMBER OF CHARACTERS LEFT IN BUFFER (INPUT FILE)
#ifndef _FCBLFT
#define _FCBLFT 24
#endif

// Decimal 25 (0x19/$19) [Constant] - OFFSET TO FCB DATA BUFFER (256 BYTES)
#ifndef _FCBCON
#define _FCBCON 25
#endif
