...
begin
  LSession := CCobadoSession.Create(nil);
  try
    LSession.FSocket := ASocket;
    LBuffer := EmptyStr;
    while True do begin
      ...
      case LChar of
        #13: begin
          ...
          if (Length(LBuffer) > 1) and (LBuffer[1] = ':') then begin
            LSession.Command(Copy(LBuffer, 2, MaxInt));
          end;
          LBuffer := EmptyStr;
        end;
        #8: begin
