...
L8E0C	PSHS	B,A,CC	SAVE ACCD AND INTERRUPT STATUS
	...
	CLR	PIA1	SET RS232 OUTPUT TO SPACING
...
L8E1D	LDA	$02,S	GET OUTPUT BYTE
	...
	LDA	#$02	OUTPUT BIT = 1; SET RS232 TO MARKING
L8E25	STA	PIA1	BET RS232 TO VALUE IN ACCA
	BSR	L8DF7	DELAY FOR AWHILE
	ASL	,S	SHIFT BIT CTR
	BCC	L8E1D	WHEN CARRY SET, 8 BITS DONE
	LDA	#$02	WHEN DONE, SET RS232 TO MARKING
	STA	PIA1	SET RS232 OUTPUT
